...
local ApiDumpRaw = require("ApiDumpRaw")
...
function Class.GetPropertyDefault(self: Class, property: string): any
	...
	if self._other.defaultProperties[property] == nil then
		local _success, defaultValue = xpcall(function()
			return (self._other.defaultInstance :: any)[property]
		end, function() end)

		-- must be cast to support string indexing
		self._other.defaultProperties[property] = defaultValue
	end
